...
fn main() {
    ...
    let mut cc_args = vec![
        ...
        "-I",
        "/home/amiriox/opt/riscv64-gnu-toolchain-elf-bin/riscv64-unknown-elf/include/",
        "-fvisibility=default",
    ];
    ...
    bindings_builder = add_font_headers(bindings_builder, &font_extra_src);
    ...
    let mut final_clang_args = Vec::new();
    final_clang_args.extend_from_slice(&cc_args);
    final_clang_args.extend_from_slice(&additional_args);
    final_clang_args.push("-target");
    final_clang_args.push("riscv64");
    final_clang_args.push(&format!("-I{}", "/home/amiriox/opt/riscv64-gnu-toolchain-elf-bin/riscv64-unknown-elf/include/"));

    let bindings = bindings_builder
        .clang_args(final_clang_args)
        .generate()
    ...
    let bindings = bindgen::Builder::default()
        .header(shims_dir.join("lvgl_sys.h").to_str().unwrap())
        .clang_arg(format!("-I{}", "/home/amiriox/opt/riscv64-gnu-toolchain-elf-bin/riscv64-unknown-elf/include/"))
        .generate()
        .expect("Unable to generate bindings");
